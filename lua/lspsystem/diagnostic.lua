...
local act = require('lspsystem.codeaction')
...
function diag:code_action_cb(hi_name)
  ...
  api.nvim_create_autocmd('CursorMoved', {
    ...
    desc = 'Lspsystem show code action preview in diagnostic window',
  })
...
local function cursor_diagnostic()
  local diags = require('lspsystem.showdiag'):get_diagnostic({ cursor = true })
  local res = {}
...
function diag:goto_next(opts)
  local incursor = require('lspsystem.showdiag'):get_diagnostic({ cursor = true })
  local entry
...
function diag:on_insert()
  ...
  local group = api.nvim_create_augroup('Lspsystem Diagnostic on insert', { clear = true })
